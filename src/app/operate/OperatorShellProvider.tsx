// src/app/operate/OperatorShellProvider.tsx
// Operator panel shell. Renders in the developer's brand-tokens theme
...
//
// Avatar menu:
//   - Operator (current — clicking does nothing, this is the current view)
...
export function OperatorShellProvider({ user, availableRoles, appIdentity, children }: Props) {
  ...
  // opens a NEW TAB (named-window pattern) so the operator tab persists.
