// src/app/operate/components/AIConfigurationCard.tsx
// Operator-panel UI for the reasoning model selection. Reads/writes
// project_state.decisions.reasoning_model_v1 via /api/operate/ai-configuration.
//
// Choice surfaces:
...
export function AIConfigurationCard(): JSX.Element {
  ...
  useEffect(() => {
    void (async () => {
      try {
        const res  = await lensFetch('/api/operate/ai-configuration');
