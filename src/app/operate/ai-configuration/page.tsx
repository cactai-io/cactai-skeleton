// src/app/operate/ai-configuration/page.tsx
//
...
// in the deployed app's operate panel keeps the deployed-side surfaces:
//
...
// end users to manage THEIR OWN keys) lives outside the operate panel —
// operate is the developer's surface, not the end user's.
