// src/app/operate/skill-reports/page.tsx
//
// v1.3.5 — Developer operate-panel report view. DORMANT in v1.
//
...
async function fetchReports(): Promise<SkillReportRow[]> {
  ...
  try {
    const res = await fetch(`${endpoints.cactaiBase}/v1/operate/skill-reports`, {
