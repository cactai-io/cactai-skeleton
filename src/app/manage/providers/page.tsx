// src/app/manage/providers/page.tsx
//
...
//   - Model selection per provider (the existing /manage/ai-configuration
//     page handles AI model tier; this page handles which providers are
//     configured at all).
//
// Auth: requireDevRole — same gate as the rest of /manage. Inside
