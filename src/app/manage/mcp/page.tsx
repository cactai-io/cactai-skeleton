...
//
// Path note: this page sits under /manage/* so it's gated by
// requireManageRole through the parent layout — sufficient for sprint 1
...
// this surface to a path without the manage-role gate (e.g. /mcp or
