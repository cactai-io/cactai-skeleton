...
export function AuthoringInterface({ type, onCancel, onAssist, onSave }) {
    ...
    const handleSave = async () => {
        ...
        setSaveResult(null);
        try {
            setSaveResult(await onSave(type, values));
        }
        catch (err) {
