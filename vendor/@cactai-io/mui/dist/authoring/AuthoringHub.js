...
export function AuthoringHub({ activeType, onSelectType, onBack, onAssist, onSave }) {
    if (activeType) {
        return (_jsx("div", { className: "ds-panel", children: _jsx(AuthoringInterface, { type: activeType, onCancel: onBack, onAssist: onAssist, onSave: onSave }) }));
    }
