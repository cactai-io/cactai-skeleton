...
export declare const PLATFORM_CATALOG: MCPCatalogEntry[];
...
export declare const MCP_CATALOGS: {
    readonly platform: MCPCatalogEntry[];
...
export declare const MCP_EXPLAINERS: {
    readonly platform: readonly ["Connect the tools you run your business on. MCP lets Cactai exchange data with your accounting, planning, analytics, and ops systems — across every project in your account.", "For example: export your usage and revenue into your accounting tool, or pull roadmap items from your planning app."];
