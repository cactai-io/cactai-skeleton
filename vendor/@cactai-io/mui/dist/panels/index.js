...
function TiersTab() {
    ...
    return (_jsxs("div", { className: "ds-panel-section", children: [_jsx("div", { className: "ds-panel-section-title", children: "Tiers" }), _jsx("div", { className: "ds-card-body", style: { fontSize: 11.5, marginBottom: 8, color: 'var(--ds-text-2)' }, children: "Pricing/access tiers, each with per-provider budgets for your Included providers. Defaults are seeded during the workflow; view and adjust them here." }), _jsx("div", { className: "ds-card", style: { background: 'var(--ds-canvas)', marginBottom: 10 }, children: _jsxs("div", { style: { fontSize: 11, color: 'var(--ds-text-2)', lineHeight: 1.5 }, children: [_jsx("strong", { children: "Setup order:" }), " Included providers (AI tab) \u2192 User Roles \u2192 Tiers \u2192 budgets per tier. You can scaffold partially across tabs \u2014 nothing here hard-blocks. A provider added later auto-appears in every tier at budget 0 until you review it."] }) }), _jsx("div", { style: { display: 'flex', gap: 6, marginBottom: 10, flexWrap: 'wrap' }, children: DEFAULT_TIER_SETS.map(s => (_jsx("button", { className: `ds-view-btn${pick === s.id ? ' ds-view-active' : ''}`, onClick: () => setPick(s.id), style: { fontSize: 11 }, children: s.label }, s.id))) }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: 8 }, children: set.tiers.map(t => (_jsxs("div", { className: "ds-card", children: [_jsx("div", { style: { fontSize: 12, color: 'var(--ds-text)', fontWeight: 600, marginBottom: 6 }, children: t }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: 4 }, children: includedExamples.map(name => (_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 8 }, children: [_jsx("span", { style: { fontSize: 11, color: 'var(--ds-text-2)', flex: 1 }, children: name }), _jsx("input", { type: "number", min: 0, placeholder: "0", style: {
                                        ...
                                        } }), _jsx("span", { style: { fontSize: 10.5, color: 'var(--ds-text-3)' }, children: "tokens / mo" })] }, name))) })] }, t))) }), _jsx("div", { className: "ds-card-body", style: { fontSize: 10.5, color: 'var(--ds-text-3)', marginTop: 8 }, children: "Budget values, the live Included-provider list, and tier add/remove (with the reassignment prompt) persist with the functional build." })] }));
}
