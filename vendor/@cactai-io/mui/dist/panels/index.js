...
export function WorkspacePanel({ projectName, githubRepoUrl, vercelDashUrl, vercelPreviewUrl, onOpenApp, syncState, onViewPendingEdits, onOpenGuide, updateStatus, onOpenUpdate, }) {
    ...
    return (_jsxs("div", { className: "ds-panel", children: [_jsxs("div", { className: "ds-panel-header", children: [_jsx("span", { className: "ds-panel-header-title", children: "Workspace" }), _jsxs("div", { style: { display: 'flex', gap: 6, alignItems: 'center' }, children: [updateStatus?.has_update && onOpenUpdate && (_jsx("button", { type: "button", onClick: onOpenUpdate, title: "Apply the latest Cactai platform update", style: {
                                    ...
                                    cursor: 'pointer',
                                    whiteSpace: 'nowrap',
                                }, children: "\u21BB Updates available" })), showPendingButton && (_jsx("button", { type: "button", className: "ds-panel-header-commit", onClick: onViewPendingEdits, children: "View pending edits" }))] })] }), _jsxs("div", { className: "ds-panel-section", children: [_jsx("div", { className: "ds-panel-section-title", children: "Project" }), _jsxs("div", { className: "ds-card", children: [_jsx("div", { style: { display: 'flex', alignItems: 'center', gap: 8 }, children: _jsx("div", { className: "ds-card-title", style: { flex: 1 }, children: projectName }) }), _jsxs("div", { style: { display: 'flex', gap: 8, flexWrap: 'wrap', marginTop: 4 }, children: [githubRepoUrl && (_jsx("a", { href: githubRepoUrl, target: "_blank", rel: "noopener noreferrer", className: "ds-btn-ghost", style: { fontSize: 11.5, padding: '4px 10px' }, children: "GitHub \u2197" })), vercelDashUrl && (_jsx("a", { href: vercelDashUrl, target: "_blank", rel: "noopener noreferrer", className: "ds-btn-ghost", style: { fontSize: 11.5, padding: '4px 10px' }, children: "Vercel \u2197" }))] })] })] })] }));
}
...
export function AppConfigurationPanel({ credentials, dashboardUrl, onSaveCredential, capabilityCatalogue, capabilityConfig, onCapabilityPatch, personality, onPersonalityPatch, onPersonalityLoad, onPersonalitySave, onPersonalityTest, onCreatePersonality, workflow, onWorkflowPatch, byok, onBYOKPatch, marketplaceWorkflowsUrl, mcpServers, mcpCatalog, mcpExplainer, mcpLoading, onMCPAdd, onMCPRemove, onMCPToggle, themeInspectorSlot, onOpenAuthoring, roleCatalog, onRolePatch, agentConfig, onAgentToggle, aiPolicy, onAIPolicyPatch, appModelSelections, onAppModelSelectionsChange, tiers, onTierBudgetPatch, tabVisibility, sharingConfig, onSharingPatch, collaborationConfig, onCollaborationPatch, aiActions, onAIActionsPatch, customTabs, onAddCustomTab, }) {
    ...
    return (_jsxs("div", { className: "ds-panel", children: [_jsxs("div", { style: { display: 'flex', gap: 4, flexWrap: 'wrap' }, children: [tabs.map((t) => (_jsx("button", { className: `ds-view-btn${tab === t.key ? ' ds-view-active' : ''}`, onClick: () => setTab(t.key), style: { fontSize: 11.5 }, children: t.label }, t.key))), onAddCustomTab && (_jsx(CustomTabAdder, { onAddCustomTab: onAddCustomTab }))] }), tab === 'workflow' && (workflow && onWorkflowPatch
                ...
                : _jsx(ConfigLoading, { title: "Skills" })), tab === 'ai' && (_jsxs(_Fragment, { children: [onAppModelSelectionsChange && (_jsxs("div", { className: "ds-panel-section", children: [_jsx("div", { className: "ds-panel-section-title", children: "App models" }), _jsx("div", { className: "ds-card-body", style: { fontSize: 11.5, marginBottom: 12, color: 'var(--ds-text-2)', lineHeight: 1.5 }, children: "Which provider + model your deployed app uses for chat and generative calls. End users can override per-capability from their own settings when BYOK or User Choice is enabled below." }), _jsx(ProviderModelPanel, { owner: "app", capabilities: ['chat', 'gen'], value: appModelSelections ?? {}, onChange: (next) => { void onAppModelSelectionsChange(next); }, required: ['chat'], selections: DEFAULT_SELECTIONS, variant: "compact" })] })), _jsx(AIPolicyBudgets, { policy: aiPolicy, onPatch: onAIPolicyPatch })] })), tab === 'agents' && _jsx(AgentsTab, { onOpenAuthoring: onOpenAuthoring, agentConfig: agentConfig, onAgentToggle: onAgentToggle }), tab === 'roles' && _jsx(RolesTab, { roleCatalog: roleCatalog, onRolePatch: onRolePatch }), tab === 'tiers' && _jsx(TiersTab, { tiers: tiers, onTierBudgetPatch: onTierBudgetPatch }), tab === 'integrations' && (mcpAvailable
