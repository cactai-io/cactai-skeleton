...
export function PendingEditsModal({ files, initialSelection, committing = false, error, onCommitToDev, onDiscardOne, onDiscardAll, onOpenHistory, onCancel, }) {
    ...
    return (_jsx("div", { className: "ds-commit-modal-backdrop", role: "presentation", onClick: e => { if (e.target === e.currentTarget && !committing)
            onCancel(); }, children: _jsxs("div", { className: "ds-commit-modal-card", role: "dialog", "aria-modal": "true", "aria-labelledby": "ds-pending-edits-title", children: [_jsxs("div", { className: "ds-commit-modal-header", children: [_jsxs("div", { className: "ds-commit-modal-titles", children: [_jsx("div", { id: "ds-pending-edits-title", className: "ds-commit-modal-title", children: "Pending edits" }), _jsx("div", { className: "ds-commit-modal-subtitle", children: totalCount === 0
