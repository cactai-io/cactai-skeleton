...
export function DevChatPanel({ shell, messages, agentState, character, agentDisplayName, activeView, onCollapse, inspectorLabel, onClearInspector, streamingContent, disabled = false, className = '', style, }) {
